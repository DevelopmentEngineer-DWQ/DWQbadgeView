...
typedef NS_ENUM(NSUInteger, DWQBadgeViewAlignment)
{
...
@interface DWQBadgeView : UIView
@property (nonatomic, copy) NSString *badgeText;

#pragma mark - Customization

@property (nonatomic, assign) DWQBadgeViewAlignment badgeAlignment UI_APPEARANCE_SELECTOR;
